...
See [SPEC] for the official specification.
...
since the beginning of I2P, to replace ElGamal/AES+SessionTags [Elg-AES].
...
Reference the common structures specification [Common].
...
See the Noise "Payload Security Properties" table in [NOISE].
...
Existing I2P router implementations that have not yet implemented [NTCP2] ([Prop111])
...
Crypto types 1-3 are reserved for ECIES-ECDH-AES-SessionTag, see proposal 145 [Prop145].
...
[STS], which is the basis for the [SSU] protocol.  In Noise parlance, Alice
...
All messages include an [I2NP] Garlic Message header.
...
STREAM
    The ChaCha20/Poly1305 AEAD as specified in [RFC-7539].
...
The Garlic Message as specified in [I2NP] is as follows.
...
The New Session message is similar to the one-way Noise [NOISE] pattern
...
This is standard [NOISE] for IK with a modified protocol name.
...
In [NTCP2] ([Prop111]), we used a low-overhead XOR function using the out-of-band static key to obfuscate
...
Therefore, [Elligator2] is used to transform the ephemeral keys in the New Session and New Session Reply messages
...
As defined in [Elligator2], the encoded keys are indistinguishable from 254 random bits.
...
This corresponds to [RFC-7539], which is also
used similarly in TLS [RFC-7905].
...
A single decrypted Garlic Clove as specified in [I2NP],
...
Database Lookups from ECIES Destinations: See [Prop154],
now incorporated in [I2NP] for release 0.9.46.

This proposal requires LS2 support to publish the X25519 public key with the leaseset.
No changes are required to the LS2 specifications in [I2NP].
All support was designed, specified, and implemented in [Prop123] implemented in 0.9.38.
...
This section is copied from [Prop123].
...
to 0.9.46 to get encrypted lookup replies. See [Prop154].
...
[CRYPTO-ELG]: https://geti2p.net/docs/how/cryptography#elgamal

[ElG-AES]: https://geti2p.net/docs/how/elgamal-aes

[Elligator2]: https://elligator.cr.yp.to/elligator-20130828.pdf
  https://www.imperialviolet.org/2013/12/25/elligator.html
  See also OBFS4 code

[GARLICSPEC]: https://geti2p.net/docs/how/garlic-routing
...
[Prop111]: https://geti2p.net/spec/proposals/111

[Prop123]: https://geti2p.net/spec/proposals/123

[Prop142]: https://geti2p.net/spec/proposals/142

[Prop145]: https://geti2p.net/spec/proposals/145

[Prop152]: https://geti2p.net/spec/proposals/152

[Prop153]: https://geti2p.net/spec/proposals/153

[Prop154]: https://geti2p.net/spec/proposals/154
...
[SPEC]: https://geti2p.net/spec/ecies

[SSU]: https://geti2p.net/docs/transport/ssu

[STS]: Diffie, W.; van Oorschot P. C.; Wiener M. J., Authentication and
