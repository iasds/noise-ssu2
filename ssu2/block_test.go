...
func TestSSU2Block_Serialize_Invalid(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			block:      NewSSU2Block(BlockTypeOptions, make([]byte, 11)),
		...
		},
		{
			...
			block:      NewSSU2Block(BlockTypeAddress, make([]byte, 5)),
...
func TestIsKnownBlockType(t *testing.T) {
	tests := []struct {
		...
		{"Reserved14", BlockTypeReserved14, true},
