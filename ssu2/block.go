...
const (
	...
	TerminationRekey                   TerminationReason = 15 // Rekey
	TerminationBanned                  TerminationReason = 16 // Banned
	TerminationBadToken                TerminationReason = 17 // Bad token
	TerminationConnectionLimitReached  TerminationReason = 18 // Connection limits
	TerminationIncompatibleVersion     TerminationReason = 19 // Incompatible version
	TerminationWrongNetID              TerminationReason = 20 // Wrong net ID
	TerminationReplacedByNewSession    TerminationReason = 21 // Replaced by new session
	TerminationSecondSessionNotAllowed TerminationReason = 22 // Second session not allowed
)
...
func (r TerminationReason) String() string {
	...
	case TerminationTimeout:
		return "Timeout"
	case TerminationRekey:
		return "Rekey"
	case TerminationBanned:
		return "Banned"
	case TerminationBadToken:
		return "BadToken"
	case TerminationConnectionLimitReached:
	...
	case TerminationSecondSessionNotAllowed:
		return "SecondSessionNotAllowed"
	default:
		return "Unknown"
	}
}
