...
func keyFromRouterAddress(options map[string]string, param, label string) ([]byte, error) {
	log.WithFields(logger.Fields{"pkg": "wire", "func": "keyFromRouterAddress", "param": param, "label": label}).Debug("Extracting key from RouterAddress")
...
func IntroKeyFromRouterAddress(options map[string]string) ([]byte, error) {
	log.WithFields(logger.Fields{"pkg": "wire", "func": "IntroKeyFromRouterAddress"}).Debug("Extracting introduction key")
...
func StaticKeyFromRouterAddress(options map[string]string) ([]byte, error) {
	log.WithFields(logger.Fields{"pkg": "wire", "func": "StaticKeyFromRouterAddress"}).Debug("Extracting static public key")
